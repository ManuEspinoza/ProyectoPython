...
SECRET_KEY = 'u3c5r)mz4^la7gdi6u2_#)i1($f67e_a+jhhutrcn&bl6=nzq('
...
# Variable que almacena la dirección de la carpeta estática en la que se almacenan los estilos
STATICFILES_DIRS = [
